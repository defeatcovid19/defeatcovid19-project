# Descrizione progetto e sinossi
...
Il presente documento ha la finalità di illustrare il progetto di ricerca che il gruppo di lavoro #defeatcovid19 intende portare avanti al fine di sviluppare un sistema di supporto alle diagnosi di patologie polmonari. A tale scopo nel presente documento sarà presentato lo stato dell’arte della ricerca in ambito di machine learning e saranno inquadrate le potenzialità dello strumento che si vuole sviluppare e il percorso di sviluppo del piano di ricerca.
...
**Richiesto:** Immagine anonimizzate radiografiche polmonari di pazienti sani / affetti da polmonite / affetti da COVID19 in formato DICOM oppure equivalente.
...
**Se disponibili,** dati relative alla terapie di trattamento COVID19 somministrate ai pazienti ed esito della prognosi.
...
Saranno analizzate le RX torace e polmoni di tutti i pazienti disponibili, unitamente alle informazioni di referto, così da costruire un dataset utile all’addestramento del modello di machine learning.
...
Più nel dettaglio lo studio si pone l'obiettivo di effettuare una prima analisi d'insieme identificando i dati certamente incompatibili con il quadro clinico polmonite da COVID19, che andranno ospedalizzati e/o trattati in modi e strutture differenti; e i casi dubbi o fortemente compatibili con il quadro clinico in esame, validati con ulteriori metodi diagnostici dalla Struttura Sanitaria e/o dall'ISS.

### Studio 2: Analisi di immagini ecografiche cardiache (e polmonari)

#### Obiettivi dello studio

L’utilizzo di tecniche ecografiche consente l’analisi del comportamento fisiologico dell’organo in esame. In questa fase si procederà ad acquisire dati prodotti da un ecografo in uso presso l’ospedale sia di pazienti saini che pazienti affetti da patologie cardiache, così da poter costruire un modello di machine learning capace di identificare comportamenti patologici.
...
**Richiesto:** Immagini anonimizzate di ecografie cardiache di pazienti sani / affetti da polmonite / affetti da COVID19 (ove disponibili) in formato DICOM oppure equivalente.
...
#### Dati analizzati
Saranno analizzate le immagini ecografiche relative alla funzionalità cardiaca di tutti i pazienti disponibili, unitamente alle informazioni di referto, così da costruire un dataset utile all’addestramento del modello di machine learning.
...
Più nel dettaglio lo studio si pone l'obiettivo di effettuare una prima analisi d'insieme identificando i dati certamente incompatibili con il quadro clinico polmonite da COVID19, che andranno ospedalizzati e/o trattati in modi e strutture differenti; e i casi dubbi o fortemente compatibili con il quadro clinico in esame, che andranno validati con ulteriori metodi diagnostici dalla Struttura Sanitaria e/o dall'ISS.
